			...
			<tbody>
				<c:forEach items="${todos1}" var="todo">
					<tr>
						...
						<td><a type="button" class="btn btn-warning" href="/delete-todo?id=${todo.productCode}">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		
		<div style="font-size:30"> <a class="button" href="/add-todo1" >Add your products...</a></div>
