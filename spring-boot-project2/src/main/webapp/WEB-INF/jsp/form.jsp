...
<p id="id2">welcome ${name}</p>
 <form:form method="POST" modelAttribute="todo" >
   <fieldset class="form-group">
       ...
       <form:input path="UserId"  size="20" type="text" class="form-control" required="required"/>
       <form:label path="PetName">Enter your pet name</form:label>
       <form:input path="PetName"  size="20" type="text" class="form-control" required="required"/>
       <form:label path="Color">Enter your favourite color</form:label>
       <form:input path="Color"  size="20" type="text" class="form-control" required="required"/>
   </fieldset>
