...
<p id="id2">welcome ${name}</p>
 <form:form method="POST" modelAttribute="todo" >
   <fieldset class="form-group">
       ...
       <form:input path="ProductName"  size="20" type="text" class="form-control" required="required"/>
       <form:label path="NumberOfItemsAvailable">Number Of Items Available</form:label>
       <form:input path="NumberOfItemsAvailable" size="20" type="number" class="form-control" required="required"/>
       <form:label path="DateOfManufacturing">Date Of Manufacturing</form:label>
       <form:input path="DateOfManufacturing" size="20" type="Date" class="form-control" required="required"/>
       <form:label path="DateOfExpiry" >Date Of Expiry</form:label>
       <form:input path="DateOfExpiry" size="20" type="Date" class="form-control" required="required"/>
   </fieldset>
